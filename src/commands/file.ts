...
/**
 * Форматы, в которых обычный ответ может уехать файлом: ответ перерос
 * сообщение в чате (см. sendAnswer в ./ai.ts) или это развёрнутое
 * «!размышление» (см. handleDeep там же).
 *

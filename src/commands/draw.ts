 ...
 * и одной картинке в день на человека это дорогая рулетка: модель дорисовывает
 ...
 *
 * Теперь между командой и деньгами стоит бесплатный Gemini на быстрой
 * цепочке (см. planner ниже — картинка дороже лишних секунд на более
...
/**
 * Кто собирает промпт: быстрая цепочка (OpenRouter contrib→luna → Gemini
 * fast-хвост) — та же, что у !скажи и !трек (см. commands/ai.ts). Раньше
 ...
 * это — одна быстрая цепочка со своей головой, отдельной от !контекст,
 * и одного и того же фолбэка с ним не ждёт.
 *

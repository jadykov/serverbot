...
const HELP_TEXT = [
  ...
  'Ещё рисую, пишу песни, озвучиваю, слушаю голосовые и ищу по переписке раздела.',
  '',
  '<b>Главное</b>',
  ...
  'низкий, высокий, бодрый, твёрдый, мягкий, яркий, напористый, уверенный —',
  'или любая манера словами: <code>«шёпотом»</code>, <code>«как в Warcraft 3»</code>.',
  ...
  `«на две минуты»), по умолчанию ${config.goapi.music.duration} с. Без вокала — скажите «инструментал».`,
  'Это платно, как и картинки, поэтому норма своя и небольшая.</blockquote>',
  '',

...
const HELP_TEXT = [
  ...
  'Ещё рисую, озвучиваю и ищу по переписке раздела.',
  '',
  '<b>Главное</b>',
  ...
  '',
  '<b>Голоса.</b> <code>/гем !скажи «низкий» смена закончена</code>. В кавычках:',
  ...
  'Без текста прочитаю то, на что вы ответили, иначе — свой последний ответ.</blockquote>',
  '',

...
const HELP_TEXT = [
  ...
  `<code>/гем !deepseek вопрос</code> — долгое размышление (платно, ${config.deepQuota.perUserPerDay} в день)`,
  ...
  '<code>!сеть</code> ходит в интернет и даёт ссылки на источники, а <code>!deepseek</code> думает',

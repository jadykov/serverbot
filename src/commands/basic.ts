...
const HELP_TEXT = [
  ...
  `<code>/гем !deepseek вопрос</code> — долго подумать над одним вопросом (платно, ${config.deepQuota.perUserPerDay} в день)`,
  ...
  '',
  '<b>Долгое размышление.</b> <code>/гем !deepseek что значит «понимать» текст</code> —',

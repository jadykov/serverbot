...
const HELP_TEXT = [
  ...
  '',
  '<b>Главное</b>',
  '<code>/гем</code> <i>вопрос</i> — спросить (слеш можно не писать). Латиницей: <code>/gem</code>',
  ...
  '<code>/гем !скажи</code> <i>текст</i> — озвучить, голос и манеру можно попросить своими словами*',
  '<code>/гем !расшифруй</code> реплаем на голосовое — выпишу сказанное дословно',
  '<code>/гем !расшифруй с ответом</code> реплаем — отвечу по существу, без выписки',
  '',

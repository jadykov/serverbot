...
export const config = {
   ...
   *
   * Норма щедрее, чем у картинок и треков, потому что и стоит поиск дешевле:
   * около $0,004 за запрос против $0,015 за картинку — вчетверо меньше.
   * Десять поисков в день на человека — это максимум четверть доллара в день
   * на всю группу, и то если каждый выберет норму до конца, чего не бывает.
   *

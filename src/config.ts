...
export const config = {
  ...
  ai: {
     ...
     *
     * Сотня — это полсотни обменов репликами, то есть живой разговор,
     * а не «модель забыла, о чём речь, через десять сообщений». Упереться
     * в окно модели тут невозможно: сто реплик — это тысяч десять токенов
     * при окне в сотни тысяч. Ограничения совсем другие:
     *
     *  • скорость. Длинный контекст модель читает дольше, и это единственное,
     *    что человек реально почувствует;
     *  • файл сессии. История лежит на диске целиком, сто реплик — сотни
     *    килобайт на топик. При десятке топиков это всё ещё мелочь;
     *  • история общая на раздел, а не на человека: в топике с пятью
     *    собеседниками сотня реплик набегает за вечер.
     */

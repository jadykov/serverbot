...
export const config = {
  ...
  goapi: {
    ...
    music: {
       ...
       * стоит денег: четырёхминутный трек — это $0,12, то есть четверть
       * стартового баланса за одну команду. Просить дольше потолка можно,
       * запрос просто урежется.
       */
      maxDuration: envInt('TRACK_MAX_DURATION', 120),

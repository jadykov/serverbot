...
function systemPrompt(grounded: boolean): string {
  return [
    ...
    'Смайлики — максимум два на ответ и только уместно; в длинном ответе можно добавить строгие маркеры-разметку',
    '(📌 ❗️ ⚠️ ✅ в начале заголовка или важной строки, текстовые • → · для структуры), не чаще одного маркера на блок.',

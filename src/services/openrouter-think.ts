...
function systemPrompt(grounded: boolean): string {
  return [
    ...
    '',
    'Разметка — обычный Markdown: **жирный** только для заголовков, 1–3 ключевых слова —',
    'в ++плюсах++ (подчёркивание), *курсив* редко и только для названий, `код`, списки на ▪.',
    'Смайлики — максимум два на ответ и только уместно.',

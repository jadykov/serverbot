...
const MARKUP_RULES = [
  ...
  '++подчёркнутый++ — для 1–3 самых ключевых слов ответа (имя, число, название), больше трёх не ставь;',
  '`инлайн-код`, блоки кода в тройных обратных кавычках с указанием языка,',
  'ссылки вида [текст](https://...), цитаты через >, списки на ▪.',
  '*курсив* — редко: только для названий произведений и чужих терминов, не для выделения важного (важное — в ++плюсах++).',

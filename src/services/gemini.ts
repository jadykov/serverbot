...
/**
 * Смайлики — акцент, а не украшение.
 *
 ...
 * не попадают. Уместность обязательна: не в каждое сообщение, в коротком
 * ответе на две-три строки — ничего.
 */
const EMOJI_RULES = [
  'Смайлики — акцент, а не украшение: на сообщение либо 1 цветной по его настроению,',
  'либо 1 цветной + 1 текстовый (· →), либо 2 текстовых. Больше двух значков нельзя, цветных — максимум один.',
  'Ставь только уместно и не в каждое сообщение: в коротком ответе на две-три строки смайликов нет совсем.',

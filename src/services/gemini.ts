 ...
 * не попадают. В длинном ответе сверху можно добавить строгие маркеры
 * (📌 ❗️ ⚠️ ✅ в начале заголовка или важной строки, текстовые • → ·
 * для структуры) — только как разметку для освежения текста.
...
const EMOJI_RULES = [
  ...
  'В длинном ответе (от 4–5 абзацев) можно добавить строгие маркеры-разметку для освежения текста:',
  'только 📌 ❗️ ⚠️ ✅ в начале заголовка или важной строки и текстовые • → · для структуры;',
  'не чаще одного маркера на блок, не в каждую строку, не подряд.',

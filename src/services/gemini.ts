 ...
 * Смайлики запрещены.
 *
 * Раньше здесь был закреплённый набор значков (⚠️📌✅❌💡) как элемент
 * разметки. Владелец решил иначе: вёрстка держится на заголовках,
 * подчёркивании и списках, а цветные смайлики выглядят пёстро и тяжело,
 * особенно на слабых устройствах. Единственное исключение — значки,
 * которые определяет сама команда (в «!сети» это 📰 и 🔗).
 */
const EMOJI_RULES = [
  'Смайлики в ответе не ставь вовсе — ни цветные, ни текстовые, ни в заголовках, ни в конце строк.',
  'Разметка держится на заголовках, ++подчёркивании++ ключевых слов и списках на ▪.',
].join(' ');

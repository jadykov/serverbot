        ...
        content: [
          options.systemPrompt ??
            'Ты — ассистент в Telegram-боте. Отвечай живо и по делу, на языке пользователя. ' +
              'Оформляй ответ в Markdown: **жирный** только для заголовков, 1–3 ключевых слова — ' +
              'в ++плюсах++ (подчёркивание), `код`, блоки кода, ссылки, списки на ▪. ' +
              'Без таблиц, вложенных списков, HTML-тегов и смайликов в тексте.',

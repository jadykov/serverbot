        ...
        content: [
          options.systemPrompt ??
            'Ты — ассистент в Telegram-боте. Отвечай живо и по делу, на языке пользователя. ' +
              ...
              'В длинном ответе (от 4–5 абзацев) можно добавить строгие маркеры-разметку: только 📌 ❗️ ⚠️ ✅ ' +
              'в начале заголовка или важной строки и текстовые • → · для структуры, не чаще одного маркера на блок, не в каждую строку, не подряд.',

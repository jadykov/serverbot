 ...
 *
 * Норм три, и они независимы: картинки, треки и живой поиск платятся разным
 * сервисам и разными деньгами, так что общий счётчик врал бы всем. Логика
 * у них при этом одна до буквы — поэтому здесь фабрика, а не три похожих
 * модуля.
 *

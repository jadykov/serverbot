 ...
 *
 * Норм две, и они независимы: картинки и треки платятся разным сервисам
 * и разными деньгами, так что общий счётчик врал бы обоим. Логика у них
 * при этом одна до буквы — поэтому здесь фабрика, а не два похожих модуля.
 *

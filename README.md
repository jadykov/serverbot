...
| `/подумай <задача>` | Сложный вопрос сильной моделью. Латинский синоним — `/think` |
...
│   │   ├── ai.ts              # /гем /подумай /ask /draw /ai /reset + картинки на вход
...
GEMINI_API_KEY=AIza...               # чтобы работали /гем, /подумай, /ask и разбор картинок
...
| `GEMINI_CHAIN_THINK` | см. `.env.example` | Цепочка для `/подумай` — дневная норма невелика |
